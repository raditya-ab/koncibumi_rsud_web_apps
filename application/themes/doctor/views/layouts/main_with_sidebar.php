...
<body id="kt_body"
    class="page-loading-enabled page-loading header-fixed header-mobile-fixed sidebar-enabled page-loading">
    ...
    <!-- <script src="<?php echo base_url('assets/js/pages/crud/ktdatatable/base/data-ajax.js');?>"></script> -->
    <!--end::Page Scripts-->
