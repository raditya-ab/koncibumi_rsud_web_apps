									...
									<ul class="menu-nav">
										...
										<li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
											...
											<a href="javascript:;" class="menu-link menu-toggle">
												<span class="menu-text">Permohonan Obat</span>
												...
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="<?php echo site_url('order/lists/new');?>" class="menu-link">
															...
															<span class="menu-text">Permohonan Baru</span>
														</a>
													</li>
													<li class="menu-item" aria-haspopup="true">
														<a href="<?php echo site_url('order/lists');?>" class="menu-link">
															<span class="svg-icon menu-icon">
															...
															<span class="menu-text">Riwayat Permohonan Obat</span>
														</a>
													</li>
												</ul>
											</div>
