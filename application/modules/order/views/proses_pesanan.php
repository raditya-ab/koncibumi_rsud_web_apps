														...
														<div class="form-group row">
															...
															<div class="col-md-10">
																<div class="accordion accordion-solid accordion-toggle-plus"
																	...
																	<div class="card">
																		<div class="card-header" id="heading_kunjungan-2">
																			<div class="card-title collapsed"
																				data-toggle="collapse"
																				data-target="#kunjungan-2">
																				<i class="flaticon-file-2"></i> No.
																				Kunjungan #191210094311A
																			</div>
																		</div>
																		<div id="kunjungan-2" class="collapse"
																			data-parent="#accordionKunjungan">
																			<div class="card-body">
																				<ul>
																					<li>
																				...
																				<a href="#resep-form-group"
																					class="btn btn-outline-warning btn-sm font-weight-bold mt-8 btn-fetch-resep" data-category="kunjungan" data-id="2" data-kode="200102134146D">Gunakan
																					Resep Ini untuk meresepkan obat</a>
																			</div>
																		</div>
																	</div>
																	<div class="card">
																		<div class="card-header" id="heading_kunjungan-3">
																			<div class="card-title collapsed"
																				data-toggle="collapse"
																				data-target="#kunjungan-3">
																				<i class="flaticon-file-2"></i> No.
																				Kunjungan #191210094311A
																			</div>
																		</div>
																		<div id="kunjungan-3" class="collapse"
																			data-parent="#accordionKunjungan">
																			<div class="card-body">
																				<ul>
																					<li>
																				...
																				<a href="#resep-form-group"
																					class="btn btn-outline-warning btn-sm font-weight-bold mt-8 btn-fetch-resep" data-category="kunjungan" data-id="3" data-kode="200102134146D">Gunakan
																					Resep Ini untuk meresepkan obat</a>
																			</div>
																		</div>
																	</div>
														...
														<div class="form-group row">
															...
															<div class="col-md-10">
																<div class="accordion accordion-solid accordion-toggle-plus"
																	...
																	<div class="card">
																		<div class="card-header" id="heading_pesanan-2">
																			<div class="card-title collapsed"
																				data-toggle="collapse"
																				data-target="#pesanan-2">
																				<i class="flaticon-file-2"></i> No.
																				Pesanan #20201001-01
																			</div>
																		</div>
																		<div id="pesanan-2" class="collapse"
																			data-parent="#accordionPesanan">
																			<div class="card-body">
																				<ul>
																					<li>
																				...
																				<a href="#resep-form-group"
																					class="btn btn-outline-warning btn-sm font-weight-bold mt-8 btn-fetch-resep" data-category="pesanan" data-id="2" data-kode="200102134146D">Gunakan
																					Resep Ini untuk meresepkan obat</a>
																			</div>
																		</div>
																	</div>
																	<div class="card">
																		<div class="card-header" id="heading_pesanan-3">
																			<div class="card-title collapsed"
																				data-toggle="collapse"
																				data-target="#pesanan-3">
																				<i class="flaticon-file-2"></i> No.
																				Pesanan #20201001-01
																			</div>
																		</div>
																		<div id="pesanan-3" class="collapse"
																			data-parent="#accordionPesanan">
																			<div class="card-body">
																				<ul>
																					<li>
																				...
																				<a href="#resep-form-group"
																					class="btn btn-outline-warning btn-sm font-weight-bold mt-8 btn-fetch-resep" data-category="pesanan" data-id="3" data-kode="200102134146D">Gunakan
																					Resep Ini untuk meresepkan obat</a>
																			</div>
																		</div>
																	</div>
