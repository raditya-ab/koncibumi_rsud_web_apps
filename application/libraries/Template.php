...
class Template
{
	...
	public function prepend_title($title)
	{
		...
		{
			$this->_title = $title . $this->_title_separator . $this->_title;
		}
	...
	public function set_metadata($name, $content, $type = 'meta')
	{
		...
		switch($type)
		{
			...
			case 'link':
				$this->_metadata[$content] = '<link rel="'.$name.'" type="text/css" href="'.$content.'" />';
			break;
		}
